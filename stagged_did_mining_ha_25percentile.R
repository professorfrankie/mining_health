...
treatment_capital_child_mort <- st_read("/home/francesca/brazil_mining/mining_health/processed data/treatment_capital_child_mort.gpkg") %>% 
  ...
  mutate(
    mining_p25_mine = quantile(mining_ha_total[status == "mine"], 0.25, na.rm = TRUE),
    crossed = mining_ha_total > mining_p25_mine
  ) %>%
...
treatment_capital_child_mort_2019_art <- st_read("/home/francesca/brazil_mining/mining_health/processed data/treatment_capital_child_mort.gpkg") %>% 
  ...
  ungroup() %>% 
  mutate(
    mining_p25_mine = quantile(mining_ha_artisanal[status == "mine"], 0.25, na.rm = TRUE),
    crossed = mining_ha_artisanal > mining_p25_mine
  ) %>% 
    group_by(muni_id) %>% 
  mutate(
    G = case_when(
...
treatment_capital_child_mort_2019_art_share <- st_read("/home/francesca/brazil_mining/mining_health/processed data/treatment_capital_child_mort.gpkg") %>% 
  filter(between(year, 1998, 2019)) %>%
  group_by(muni_id) %>%
  filter(any(mining_ha_artisanal_share > 0.5)) %>%
  filter(!any(dist_n >= 3, na.rm = TRUE)) %>% 
  ungroup() %>% 
  mutate(
    mining_p25_mine = quantile(mining_ha_artisanal[status == "mine"], 0.25, na.rm = TRUE),
...
treatment_capital_child_mort_2019_ind <- st_read("/home/francesca/brazil_mining/mining_health/processed data/treatment_capital_child_mort.gpkg") %>% 
  ...
  ungroup() %>% 
  mutate(
    mining_p25_mine = quantile(mining_ha_industrial[status == "mine"], 0.25, na.rm = TRUE),
    crossed = mining_ha_industrial > mining_p25_mine
  ) %>%
  group_by(muni_id) %>% 
  mutate(
    G = case_when(
...
treatment_capital_child_mort_2019_ind_share <- st_read("/home/francesca/brazil_mining/mining_health/processed data/treatment_capital_child_mort.gpkg") %>% 
  filter(between(year, 1998, 2019)) %>%
  group_by(muni_id) %>%
  filter(any(mining_ha_industrial_share > 0.5)) %>%
  filter(!any(dist_n >= 3, na.rm = TRUE)) %>% 
  ungroup() %>% 
  mutate(
    mining_p25_mine = quantile(mining_ha_industrial[status == "mine"], 0.25, na.rm = TRUE),
...
setwd("/home/francesca/brazil_mining/mining_health/figures/mining_ha_25percentile/stagged_did_1998/")
...
### with weights
setwd("/home/francesca/brazil_mining/mining_health/figures/mining_ha_25percentile/stagged_did_1998_weights/")
#toxic effects
...
setwd("/home/francesca/brazil_mining/mining_health/figures/mining_ha_25percentile/stagged_did_2001/")
...
### with weights
setwd("/home/francesca/brazil_mining/mining_health/figures/mining_ha_25percentile/stagged_did_2001_weights/")
#toxic effects
capital_toxic_controls_2019_weighted <- att_gt(yname = "toxic_effects_pc",
                                               tname = "year",
                                               idname = "muni_id",
...
setwd("/home/francesca/brazil_mining/mining_health/figures/mining_ha_25percentile/stagged_did_2003/")
...
### with weights
setwd("/home/francesca/brazil_mining/mining_health/figures/mining_ha_25percentile/stagged_did_2003_weights/")
#toxic effects
capital_toxic_controls_2019_weighted <- att_gt(yname = "toxic_effects_pc",
                                               tname = "year",
                                               idname = "muni_id",
