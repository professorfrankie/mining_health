...
treatment_capital_child_mort <- st_read("/home/francesca/brazil_mining/mining_health/processed data/treatment_capital_child_mort.gpkg") %>% 
  ...
  mutate(
    mining_p25_mine = quantile(cumulative_mining[status == "mine"], 0.25, na.rm = TRUE),
    crossed = cumulative_mining > mining_p25_mine
  ) %>% 
  ...
  mutate(
    G = case_when(
      ...
      all(is.na(basin_id)) ~ NA_real_,                                      # NEW CONDITION
      all(!crossed, na.rm = TRUE) ~ NA_real_,                                # never crossed
      TRUE ~ min(year[crossed %in% TRUE], na.rm = TRUE),                     # first crossing
    )
  ) %>% 
...
treatment_combined_child_mort <- st_read("/home/francesca/brazil_mining/mining_health/processed data/treatment_combined_child_mort.gpkg") %>%
  group_by(muni_id) %>%
  filter(!any(dist_n >= 3, na.rm = TRUE)) %>% 
  ungroup() %>% 
  # global median threshold
...
treatment_overlap_child_mort <- st_read("/home/francesca/brazil_mining/mining_health/processed data/treatment_overlap_child_mort.gpkg") %>%
  group_by(muni_id) %>%
  filter(!any(dist_n >= 3, na.rm = TRUE)) %>% 
  ungroup() %>% 
...
treatment_capital_hosp <- st_read("/home/francesca/brazil_mining/mining_health/processed data/treatment_capital_hosp.gpkg") %>%
  arrange(muni_id) %>%
  group_by(muni_id) %>%
  filter(!any(dist_n >= 3, na.rm = TRUE)) %>% 
  ungroup() %>% 
...
treatment_combined_hosp <- st_read("/home/francesca/brazil_mining/mining_health/processed data/treatment_combined_hosp.gpkg") %>%
  group_by(muni_id) %>%
  filter(!any(dist_n >= 3, na.rm = TRUE)) %>% 
  ungroup() %>% 
...
treatment_overlap_hosp <- st_read("/home/francesca/brazil_mining/mining_health/processed data/treatment_overlap_hosp.gpkg") %>%
  group_by(muni_id) %>%
  filter(!any(dist_n >= 3, na.rm = TRUE)) %>% 
  ungroup() %>% 
...
treatment_capital_child_mort_2019_art <- st_read("/home/francesca/brazil_mining/mining_health/processed data/treatment_capital_child_mort.gpkg") %>% 
  group_by(muni_id) %>% 
  filter(between(year, 1998, 2019)) %>%
  ...
  ungroup() %>% 
  mutate(
    mining_p25_mine = quantile(cumulative_artisanal[status == "mine"], 0.25, na.rm = TRUE),
    crossed = cumulative_artisanal > mining_p25_mine
  ) %>% 
  group_by(muni_id) %>% 
  mutate(
    G = case_when(
...
treatment_combined_child_mort_2019_art <- st_read("/home/francesca/brazil_mining/mining_health/processed data/treatment_combined_child_mort.gpkg") %>%
  group_by(muni_id) %>% 
  filter(between(year, 1998, 2019)) %>%
  filter(mine_type == "artisanal") %>%
  filter(!any(dist_n >= 3, na.rm = TRUE)) %>% 
  ...
  ungroup() %>% 
  filter(!is.na(G))
treatment_overlap_child_mort_2019_art <- st_read("/home/francesca/brazil_mining/mining_health/processed data/treatment_overlap_child_mort.gpkg") %>%
  group_by(muni_id) %>% 
  filter(between(year, 1998, 2019)) %>%
  filter(mine_type == "artisanal") %>%
  filter(!any(dist_n >= 3, na.rm = TRUE)) %>% 
  ...
  ungroup() %>% 
  filter(!is.na(G))
treatment_capital_hosp_2019_art <- st_read("/home/francesca/brazil_mining/mining_health/processed data/treatment_capital_hosp.gpkg") %>%
  group_by(muni_id) %>% 
  filter(between(year, 1998, 2019)) %>%
  filter(mine_type == "artisanal") %>%
  filter(!any(dist_n >= 3, na.rm = TRUE)) %>% 
  ...
  ungroup() %>% 
  filter(!is.na(G))
treatment_combined_hosp_2019_art <- st_read("/home/francesca/brazil_mining/mining_health/processed data/treatment_combined_hosp.gpkg") %>%
  group_by(muni_id) %>% 
  filter(between(year, 1998, 2019)) %>%
  filter(mine_type == "artisanal") %>%
  filter(!any(dist_n >= 3, na.rm = TRUE)) %>% 
  ...
  ungroup() %>% 
  filter(!is.na(G))
treatment_overlap_hosp_2019_art <- st_read("/home/francesca/brazil_mining/mining_health/processed data/treatment_overlap_hosp.gpkg") %>%
  group_by(muni_id) %>% 
  filter(between(year, 1998, 2019)) %>%
  filter(mine_type == "artisanal") %>%
  filter(!any(dist_n >= 3, na.rm = TRUE)) %>% 
...
treatment_capital_child_mort_2019_art_share <- st_read("/home/francesca/brazil_mining/mining_health/processed data/treatment_capital_child_mort.gpkg") %>% 
  filter(between(year, 1998, 2019)) %>%
  group_by(muni_id) %>%
  filter(any(cumulative_artisanal_share > 0.5)) %>%
  filter(!any(dist_n >= 3, na.rm = TRUE)) %>% 
  ungroup() %>% 
  mutate(
    mining_p25_mine = quantile(cumulative_artisanal[status == "mine"], 0.25, na.rm = TRUE),
...
treatment_combined_child_mort_2019_art_share <- st_read("/home/francesca/brazil_mining/mining_health/processed data/treatment_combined_child_mort.gpkg") %>%
  filter(between(year, 1998, 2019)) %>%
  group_by(muni_id) %>%
  filter(any(cumulative_artisanal_share > 0.5)) %>%
  filter(!any(dist_n >= 3, na.rm = TRUE)) %>% 
  ...
  ungroup() %>% 
  filter(!is.na(G))
treatment_overlap_child_mort_2019_art_share <- st_read("/home/francesca/brazil_mining/mining_health/processed data/treatment_overlap_child_mort.gpkg") %>%
  filter(between(year, 1998, 2019)) %>%
  group_by(muni_id) %>%
  filter(any(cumulative_artisanal_share > 0.5)) %>%
  filter(!any(dist_n >= 3, na.rm = TRUE)) %>% 
  ...
  ungroup() %>% 
  filter(!is.na(G))
treatment_capital_hosp_2019_art_share <- st_read("/home/francesca/brazil_mining/mining_health/processed data/treatment_capital_hosp.gpkg") %>%
  filter(between(year, 1998, 2019)) %>%
  group_by(muni_id) %>%
  filter(any(cumulative_artisanal_share > 0.5)) %>%
  filter(!any(dist_n >= 3, na.rm = TRUE)) %>% 
  ...
  ungroup() %>% 
  filter(!is.na(G))
treatment_combined_hosp_2019_art_share <- st_read("/home/francesca/brazil_mining/mining_health/processed data/treatment_combined_hosp.gpkg") %>%
  filter(between(year, 1998, 2019)) %>%
  group_by(muni_id) %>%
  filter(any(cumulative_artisanal_share > 0.5)) %>%
  filter(!any(dist_n >= 3, na.rm = TRUE)) %>% 
  ...
  ungroup() %>% 
  filter(!is.na(G))
treatment_overlap_hosp_2019_art_share <- st_read("/home/francesca/brazil_mining/mining_health/processed data/treatment_overlap_hosp.gpkg") %>%
  filter(between(year, 1998, 2019)) %>%
  group_by(muni_id) %>%
  filter(any(cumulative_artisanal_share > 0.5)) %>%
  filter(!any(dist_n >= 3, na.rm = TRUE)) %>% 
...
treatment_capital_child_mort_2019_ind <- st_read("/home/francesca/brazil_mining/mining_health/processed data/treatment_capital_child_mort.gpkg") %>% 
  group_by(muni_id) %>% 
  filter(between(year, 1998, 2019)) %>%
  ...
  ungroup() %>% 
  mutate(
    mining_p25_mine = quantile(cumulative_industrial[status == "mine"], 0.25, na.rm = TRUE),
    crossed = cumulative_industrial > mining_p25_mine
  ) %>% 
  group_by(muni_id) %>% 
  mutate(
    G = case_when(
...
treatment_combined_child_mort_2019_ind <- st_read("/home/francesca/brazil_mining/mining_health/processed data/treatment_combined_child_mort.gpkg") %>%
  group_by(muni_id) %>% 
  filter(between(year, 1998, 2019)) %>%
  filter(mine_type == "industrial") %>%
  filter(!any(dist_n >= 3, na.rm = TRUE)) %>% 
  ...
  ungroup() %>% 
  filter(!is.na(G))
treatment_overlap_child_mort_2019_ind <- st_read("/home/francesca/brazil_mining/mining_health/processed data/treatment_overlap_child_mort.gpkg") %>%
  group_by(muni_id) %>% 
  filter(between(year, 1998, 2019)) %>%
  filter(mine_type == "industrial") %>%
  filter(!any(dist_n >= 3, na.rm = TRUE)) %>% 
  ...
  ungroup() %>% 
  filter(!is.na(G))
treatment_capital_hosp_2019_ind <- st_read("/home/francesca/brazil_mining/mining_health/processed data/treatment_capital_hosp.gpkg") %>%
  group_by(muni_id) %>% 
  filter(between(year, 1998, 2019)) %>%
  filter(mine_type == "industrial") %>%
  filter(!any(dist_n >= 3, na.rm = TRUE)) %>% 
  ...
  ungroup() %>% 
  filter(!is.na(G))
treatment_combined_hosp_2019_ind <- st_read("/home/francesca/brazil_mining/mining_health/processed data/treatment_combined_hosp.gpkg") %>%
  group_by(muni_id) %>% 
  filter(between(year, 1998, 2019)) %>%
  filter(mine_type == "industrial") %>%
  filter(!any(dist_n >= 3, na.rm = TRUE)) %>% 
  ...
  ungroup() %>% 
  filter(!is.na(G))
treatment_overlap_hosp_2019_ind <- st_read("/home/francesca/brazil_mining/mining_health/processed data/treatment_overlap_hosp.gpkg") %>%
  group_by(muni_id) %>% 
  filter(between(year, 1998, 2019)) %>%
  filter(mine_type == "industrial") %>%
  filter(!any(dist_n >= 3, na.rm = TRUE)) %>% 
...
treatment_capital_child_mort_2019_ind_share <- st_read("/home/francesca/brazil_mining/mining_health/processed data/treatment_capital_child_mort.gpkg") %>% 
  filter(between(year, 1998, 2019)) %>%
  group_by(muni_id) %>%
  filter(any(cumulative_industrial_share > 0.5)) %>%
  filter(!any(dist_n >= 3, na.rm = TRUE)) %>% 
  ungroup() %>% 
  mutate(
    mining_p25_mine = quantile(cumulative_industrial[status == "mine"], 0.25, na.rm = TRUE),
...
treatment_combined_child_mort_2019_ind_share <- st_read("/home/francesca/brazil_mining/mining_health/processed data/treatment_combined_child_mort.gpkg") %>%
  filter(between(year, 1998, 2019)) %>%
  group_by(muni_id) %>%
  filter(any(cumulative_industrial_share > 0.5)) %>%
  filter(!any(dist_n >= 3, na.rm = TRUE)) %>% 
  ...
  ungroup() %>% 
  filter(!is.na(G))
treatment_overlap_child_mort_2019_ind_share <- st_read("/home/francesca/brazil_mining/mining_health/processed data/treatment_overlap_child_mort.gpkg") %>%
  filter(between(year, 1998, 2019)) %>%
  group_by(muni_id) %>%
  filter(any(cumulative_industrial_share > 0.5)) %>%
  filter(!any(dist_n >= 3, na.rm = TRUE)) %>% 
  ...
  ungroup() %>% 
  filter(!is.na(G))
treatment_capital_hosp_2019_ind_share <- st_read("/home/francesca/brazil_mining/mining_health/processed data/treatment_capital_hosp.gpkg") %>%
  filter(between(year, 1998, 2019)) %>%
  group_by(muni_id) %>%
  filter(any(cumulative_industrial_share > 0.5)) %>%
  filter(!any(dist_n >= 3, na.rm = TRUE)) %>% 
  ...
  ungroup() %>% 
  filter(!is.na(G))
treatment_combined_hosp_2019_ind_share <- st_read("/home/francesca/brazil_mining/mining_health/processed data/treatment_combined_hosp.gpkg") %>%
  filter(between(year, 1998, 2019)) %>%
  group_by(muni_id) %>%
  filter(any(cumulative_industrial_share > 0.5)) %>%
  filter(!any(dist_n >= 3, na.rm = TRUE)) %>% 
  ...
  ungroup() %>% 
  filter(!is.na(G))
treatment_overlap_hosp_2019_ind_share <- st_read("/home/francesca/brazil_mining/mining_health/processed data/treatment_overlap_hosp.gpkg") %>%
  filter(between(year, 1998, 2019)) %>%
  group_by(muni_id) %>%
  filter(any(cumulative_industrial_share > 0.5)) %>%
  filter(!any(dist_n >= 3, na.rm = TRUE)) %>% 
...
setwd("/home/francesca/brazil_mining/mining_health/figures/cumulative_ha_25percentile/stagged_did_1998/")
...
### with weights
setwd("/home/francesca/brazil_mining/mining_health/figures/cumulative_ha_25percentile/stagged_did_1998_weights/")
#toxic effects
...
setwd("/home/francesca/brazil_mining/mining_health/figures/cumulative_ha_25percentile/stagged_did_2001/")
...
### with weights
setwd("/home/francesca/brazil_mining/mining_health/figures/cumulative_ha_25percentile/stagged_did_2001_weights/")
#toxic effects
capital_toxic_controls_2019_weighted <- att_gt(yname = "toxic_effects_pc",
                                               tname = "year",
                                               idname = "muni_id",
...
setwd("/home/francesca/brazil_mining/mining_health/figures/cumulative_ha_25percentile/stagged_did_2003/")
...
### with weights
setwd("/home/francesca/brazil_mining/mining_health/figures/cumulative_ha_25percentile/stagged_did_2003_weights/")
#toxic effects
capital_toxic_controls_2019_weighted <- att_gt(yname = "toxic_effects_pc",
                                               tname = "year",
                                               idname = "muni_id",
