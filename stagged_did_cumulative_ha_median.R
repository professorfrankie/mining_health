...
treatment_capital_child_mort <- st_read("/home/francesca/brazil_mining/mining_health/processed data/treatment_capital_child_mort.gpkg") %>% 
  ...
  mutate(
    mining_median_mine = median(cumulative_mining[status == "mine"], na.rm = TRUE),
    crossed = cumulative_mining > mining_median_mine
  ) %>% 
...
treatment_capital_child_mort_2019_art <- st_read("/home/francesca/brazil_mining/mining_health/processed data/treatment_capital_child_mort.gpkg") %>% 
  ...
  ungroup() %>% 
  mutate(
    mining_median_mine = median(cumulative_artisanal[status == "mine"], na.rm = TRUE),
    crossed = cumulative_artisanal > mining_median_mine
  ) %>% 
  group_by(muni_id) %>% 
  mutate(
    G = case_when(
...
treatment_capital_child_mort_2019_ind <- st_read("/home/francesca/brazil_mining/mining_health/processed data/treatment_capital_child_mort.gpkg") %>% 
  ...
  ungroup() %>% 
  mutate(
    mining_median_mine = median(cumulative_industrial[status == "mine"], na.rm = TRUE),
    crossed = cumulative_industrial > mining_median_mine
  ) %>% 
  group_by(muni_id) %>% 
  mutate(
    G = case_when(
...
setwd("/home/francesca/brazil_mining/mining_health/figures/cumulative_ha_median/stagged_did_1998/")
...
### with weights
setwd("/home/francesca/brazil_mining/mining_health/figures/cumulative_ha_median/stagged_did_1998_weights/")
#toxic effects
...
setwd("/home/francesca/brazil_mining/mining_health/figures/cumulative_ha_median/stagged_did_2001/")
...
### with weights
setwd("/home/francesca/brazil_mining/mining_health/figures/cumulative_ha_median/stagged_did_2001_weights/")
#toxic effects
capital_toxic_controls_2019_weighted <- att_gt(yname = "toxic_effects_pc",
                                               tname = "year",
                                               idname = "muni_id",
...
setwd("/home/francesca/brazil_mining/mining_health/figures/cumulative_ha_median/stagged_did_2003/")
...
### with weights
setwd("/home/francesca/brazil_mining/mining_health/figures/cumulative_ha_median/stagged_did_2003_weights/")
#toxic effects
capital_toxic_controls_2019_weighted <- att_gt(yname = "toxic_effects_pc",
                                               tname = "year",
                                               idname = "muni_id",
